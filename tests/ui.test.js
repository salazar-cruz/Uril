...
test('a interface está identificada como versão 1.0.16', () => {
  assert.match(html, /Versão 1\.0\.16/);
  assert.match(html, /AJUDA V1\.0\.16/);
  assert.match(html, /styles\.css\?v=1\.0\.16/);
  assert.match(html, /app\.js\?v=1\.0\.16/);
});
