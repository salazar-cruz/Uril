...
const TEXT = {
  pt: {
    ...
    drillObjective25: 'Objectivo: correr o ouro e fechar a posição em 25–23 contra a defesa de referência.', restartDrill: 'Recomeçar', showDrillHint: 'Mostrar pista', nextDrill: 'Drill seguinte', drillPlayer: 'Jogador', drillOpponent: 'Defesa de referência', drillStarted: 'Drill de fim de jogo iniciado.', drillMode: 'DRILL · CORRI ORO', drillPublicStatus: 'Drill público de fim de jogo · sem conta', drillHintPit: 'Pista: joga {pit}.', drillPerfectLine: 'Linha perfeita mantida · decisões: {moves}', drillLineBroken: 'Saíste da linha de referência · continua contra a IA · decisões: {moves}', drillSuccessTitle: 'O ouro foi corrido.', drillRetryTitle: 'A linha perfeita perdeu-se.', drillSuccessText: 'Resultado 25–23. Drill concluído.', drillRetryText: 'Revê a posição, usa a pista e tenta novamente.', drillOpponentThinking: 'A defesa está a calcular.', drillPerfectDefence: 'O adversário segue a melhor defesa conhecida desta posição.', drillChooseMove: 'Escolhe a continuação exacta.', statusDrill: 'A treinar Corri Oro',
    ...
    helpContent: `
      ...
      <section>
        ...
        <p>Eu criei estes exercícios públicos para treinar a fase conhecida em Cabo Verde como <strong>correr o ouro</strong> ou <strong>Corri Oro</strong>. Não exigem conta e aparecem na coluna esquerda do ecrã.</p>
  ...
  fr: {
    ...
    chatNote: 'Les messages sont transmis en temps réel et ne sont pas archivés.', whatsappShare: 'INVITER PAR WHATSAPP', whatsappShareText: 'Partage cette table avec un joueur ou une personne qui souhaite regarder.',
    ...
    helpVersion: 'AIDE 1.0.6', helpTitle: 'Aide, tables et règles', close: 'Fermer',
    helpContent: `
      ...
      <section><h3>Commencer à jouer</h3><p>Sans compte, tu entres comme visiteur anonyme pour t’entraîner contre l’IA, utiliser les exercices de fin de partie et consulter les parties. Avec un compte, tu obtiens une identité, un Elo et l’accès aux parties officielles après la calibration.</p><ul><li><strong>Contre l’ordinateur :</strong> Apprenti, Amateur, Maître et Grand Maître. L’entraînement reste privé et ne modifie jamais l’Elo.</li><li><strong>Deux joueurs :</strong> Sud et Nord alternent sur le même appareil après connexion.</li><li><strong>Tables en ligne :</strong> les joueurs inscrits et calibrés créent et disputent les parties officielles; tous les visiteurs peuvent regarder les parties Live et consulter les parties terminées.</li></ul></section>
      <section><h3>Exercices de fin de partie · Corri Oro</h3><p>J’ai créé ces exercices publics pour travailler la phase appelée au Cap-Vert <strong>courir vers l’or</strong> ou <strong>Corri Oro</strong>. Aucun compte n’est requis et le menu se trouve dans la colonne gauche.</p><p>Chaque exercice commence dans une position réaliste de fin de partie. Le but est de trouver la suite exacte contre la meilleure défense connue et de terminer à <strong>25–23</strong>. <strong>Afficher l’indice</strong> révèle la prochaine case de la ligne de référence; <strong>Recommencer</strong> rétablit la position; <strong>Exercice suivant</strong> ouvre un autre cas.</p><p>Si tu quittes la ligne préparée, l’exercice continue contre l’IA Grand Maître afin d’étudier les conséquences du choix.</p></section>
    ...
    guest: 'Invité', you: 'TOI', inGame: 'En jeu', invite: 'Inviter', occupied: 'Occupé', invitedToBank: '{nick} t’invite dans la table d’Uril « {bank} ».',
  ...
  en: {
    ...
    drillObjective25: 'Objective: run to gold and finish 25–23 against the reference defence.', restartDrill: 'Restart', showDrillHint: 'Show hint', nextDrill: 'Next drill', drillPlayer: 'Player', drillOpponent: 'Reference defence', drillStarted: 'Endgame drill started.', drillMode: 'DRILL · CORRI ORO', drillPublicStatus: 'Public endgame drill · no account', drillHintPit: 'Hint: play {pit}.', drillPerfectLine: 'Perfect line maintained · decisions: {moves}', drillLineBroken: 'You left the reference line · continue against the AI · decisions: {moves}', drillSuccessTitle: 'The gold run is complete.', drillRetryTitle: 'The perfect line was lost.', drillSuccessText: 'Result 25–23. Drill completed.', drillRetryText: 'Review the position, use the hint and try again.', drillOpponentThinking: 'The defence is calculating.', drillPerfectDefence: 'The opponent follows the best known defence for this position.', drillChooseMove: 'Choose the exact continuation.', statusDrill: 'Training Corri Oro',
    ...
    helpVersion: 'HELP 1.0.6', helpTitle: 'Help, tables and rules', close: 'Close',
    helpContent: `
      ...
      <section><h3>Table chat</h3><p>Chat is available to both players and spectators. Messages are sent in real time, limited to 280 characters and are not archived.</p></section>
      ...
      <p class="rules-note">Version 1.0.6 will continue to be refined with experienced Uril players.</p>`,
    ...
    profileTooShort: 'Enter a nickname with at least two characters first.', statusPc: 'Playing against the computer{bank}', statusLocal: 'Playing locally', statusWaiting: 'In an Uril table, waiting{bank}', statusPlaying: 'In an Uril table, playing{bank}', statusWatching: 'In an Uril table, watching{bank}', statusFree: 'Free',
    connectSupabasePlayers: 'Connect Supabase to see players.', playersConnectedOne: '1 player connected', playersConnectedMany: '{count} players connected', noPlayersConnected: 'No players connected yet.', guest: 'Guest', you: 'YOU', inGame: 'In game', invite: 'Invite', occupied: 'Busy', invitedToBank: '{nick} invited you to the Uril table “{bank}”.',
