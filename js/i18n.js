...
const TEXT = {
  ...
  fr: {
    ...
    helpVersion: 'AIDE V0.0.11', helpTitle: 'Aide, banques et règles', close: 'Fermer',
    helpContent: `
  ...
  en: {
    ...
    invitationReceived: 'INVITATION RECEIVED', genericInvite: 'You received an invitation to an Uril bank.', decline: 'Decline', enterBank: 'Enter bank', helpVersion: 'HELP V0.0.11', helpTitle: 'Help, banks and rules', close: 'Close',
    helpContent: `
