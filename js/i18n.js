...
const TEXT = {
  ...
  fr: {
    ...
    helpVersion: 'AIDE 1.0.5', helpTitle: 'Aide, banques et règles', close: 'Fermer',
    helpContent: `
  ...
  en: {
    ...
    helpVersion: 'HELP 1.0.5', helpTitle: 'Help, banks and rules', close: 'Close',
    helpContent: `
      ...
      <p class="rules-note">Version 1.0.5 will continue to be refined with experienced Uril players.</p>`,
