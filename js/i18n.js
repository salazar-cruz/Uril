...
const TEXT = {
  ...
  fr: {
    ...
    helpVersion: 'AIDE 1.0.10', helpTitle: 'Aide, tables et règles', close: 'Fermer',
    helpContent: `
  ...
  en: {
    ...
    helpVersion: 'HELP 1.0.10', helpTitle: 'Help, tables and rules', close: 'Close',
    helpContent: `
      ...
      <p class="rules-note">Version 1.0.10 will continue to be refined with experienced Uril players.</p>`,
