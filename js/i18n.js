...
const TEXT = {
  ...
  fr: {
    ...
    levelApprentice: 'Apprenti', levelAmateur: 'Amateur', levelMaster: 'Maître', levelGrandmaster: 'Grand Maître', firstMove: 'Premier coup', humanStarts: 'Je joue en premier', computerStarts: 'L’ordinateur joue en premier', startMatch: 'Commencer la partie',
    ...
    helpVersion: 'AIDE 1.0.13', helpTitle: 'Aide, tables et règles', close: 'Fermer',
    helpContent: `
  ...
  en: {
    ...
    versusComputer: 'Against the computer', versusComputerDesc: 'Individual training with four difficulty levels, watchable live. These matches never change official Elo.', level: 'Level', levelApprentice: 'Apprentice', levelAmateur: 'Amateur', levelMaster: 'Master', levelGrandmaster: 'Grand Master', firstMove: 'First move', humanStarts: 'I play first', computerStarts: 'Computer plays first', startMatch: 'Start match',
    ...
    helpVersion: 'HELP 1.0.13', helpTitle: 'Help, tables and rules', close: 'Close',
    helpContent: `
      ...
      <p class="rules-note">Version 1.0.13 will continue to be refined with experienced Uril players.</p>`,
