...
const TEXT = {
  pt: {
    ...
    assetCredit: 'Sementes adaptadas do visual clássico: Oliver Merkel, licença CC BY-NC-SA 4.0.',
  ...
  fr: {
    ...
    fullRules: 'Lire toutes les règles', assetCredit: 'Graines adaptées du visuel classique : Oliver Merkel, licence CC BY-NC-SA 4.0.',
