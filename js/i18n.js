...
const TEXT = {
  pt: {
    ...
    footerCopyright: '© 2026 Salazar da Cruz', footerConcept: 'Conceito e direcção', versionLabel: 'Versão 0.0.13', suggestions: 'Sugestões', suggestionsEyebrow: 'AJUDAR A MELHORAR', suggestionsTitle: 'Enviar sugestão', suggestionsText: 'Escreve a tua sugestão, regra ou problema encontrado.', suggestionPlaceholder: 'A tua sugestão…', suggestionEmailNote: 'A mensagem será preparada para sugestoes@devnexusdigital.com.', sendSuggestion: 'Preparar email', suggestionEmpty: 'Escreve primeiro uma sugestão.', suggestionSubject: 'Sugestão — Uril Cabo Verde v0.0.13', suggestionSignature: 'Enviado a partir da versão {version}: {url}', suggestionPrepared: 'A sugestão foi preparada no teu programa de email.',
    helpVersion: 'AJUDA V0.0.13',
