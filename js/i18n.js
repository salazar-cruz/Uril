...
const TEXT = {
  pt: {
    ...
    versusComputerDesc: 'Treino individual com quatro níveis de dificuldade.',
    level: 'Nível',
    ...
    assetCredit: 'Tabuleiro e sementes do visual clássico: Oliver Merkel, licença CC BY-NC-SA 4.0.',
    ...
    footerCopyright: '© 2026 Salazar da Cruz', footerConcept: 'Conceito e direcção', versionLabel: 'Versão 0.0.12', suggestions: 'Sugestões', suggestionsEyebrow: 'AJUDAR A MELHORAR', suggestionsTitle: 'Enviar sugestão', suggestionsText: 'Escreve a tua sugestão, regra ou problema encontrado.', suggestionPlaceholder: 'A tua sugestão…', suggestionEmailNote: 'A mensagem será preparada para sugestoes@devnexusdigital.com.', sendSuggestion: 'Preparar email', suggestionEmpty: 'Escreve primeiro uma sugestão.', suggestionSubject: 'Sugestão — Uril Cabo Verde v0.0.12', suggestionSignature: 'Enviado a partir da versão {version}: {url}', suggestionPrepared: 'A sugestão foi preparada no teu programa de email.',
    helpVersion: 'AJUDA V0.0.12',
    ...
    helpContent: `
      ...
      <section>
        ...
        <ul>
          <li><strong>Contra o computador:</strong> níveis Aprendiz, Amador, Mestre e Grande Mestre.</li>
      ...
      <section>
        ...
        <p>A coluna da esquerda actualiza-se em tempo real quando alguém entra, sai ou muda de modo. Mostra os estados: livre, a jogar contra o computador, a jogar no modo local, num banco à espera, num banco a jogar ou a ver jogar.</p>
    ...
    statusPc: 'A jogar contra o computador',
    ...
    versusPcMode: 'CONTRA O PC · {level}',
    ...
    computerLevel: 'Computador no nível {level}',
    ...
    shareOnlyOnline: 'Os convites por WhatsApp estão disponíveis dentro de um banco online.',
  ...
  fr: {
    ...
    versusComputer: 'Contre l’ordinateur', versusComputerDesc: 'Entraînement individuel avec quatre niveaux de difficulté.', level: 'Niveau',
    ...
    fullRules: 'Lire toutes les règles', assetCredit: 'Plateau et graines du visuel classique : Oliver Merkel, licence CC BY-NC-SA 4.0.',
    ...
    profileTooShort: 'Écris d’abord un pseudo d’au moins deux caractères.', statusPc: 'Joue contre l’ordinateur', statusLocal: 'Joue en mode local',
    ...
    playerAlreadyBusy: '{nick} est déjà dans une banque d’Uril.', defaultBankName: 'Banque de {nick}', invitationSent: 'Invitation envoyée à {nick}.',
    connectSupabaseBanks: 'Relie Supabase pour ouvrir les banques d’Uril en ligne.', noBanks: 'Aucune banque d’Uril. Crée la première.', waitingUpper: 'EN ATTENTE', playingUpper: 'EN JEU',
    resume: 'Reprendre', play: 'Jouer', watchPlay: 'Regarder', awaitingGuest: 'En attente…', bankOnline: 'Banque en ligne', versusPcMode: 'CONTRE LE PC · {level}', watchingMode: 'SPECTATEUR', onlineBankMode: 'BANQUE EN LIGNE', twoPlayersMode: 'DEUX JOUEURS',
    matchFinished: 'Partie terminée', turnOf: 'Tour de {player}', bankWaitingOpponent: 'Banque en attente d’un adversaire', watchingBank: 'Spectateur · Sud en bas', yourSideBelow: 'Ton camp est en bas · {player}', computerLevel: 'Ordinateur, niveau {level}', localBank: 'Banque locale sur le même appareil',
    ...
    sharePlayUnavailable: 'Cette banque a déjà deux joueurs. Envoie plutôt une invitation pour regarder.', shareOnlyOnline: 'Les invitations WhatsApp sont disponibles dans une banque en ligne.',
  ...
  en: {
    ...
    versusComputer: 'Against the computer', versusComputerDesc: 'Solo practice with four difficulty levels.', level: 'Level', levelApprentice: 'Apprentice', levelAmateur: 'Amateur', levelMaster: 'Master', levelGrandmaster: 'Grand Master', startMatch: 'Start match',
    ...
    profileTooShort: 'Enter a nickname with at least two characters first.', statusPc: 'Playing against the computer', statusLocal: 'Playing locally', statusWaiting: 'In an Uril bank, waiting{bank}', statusPlaying: 'In an Uril bank, playing{bank}', statusWatching: 'In an Uril bank, watching{bank}', statusFree: 'Free',
    ...
    chatReady: 'Write in the bank…', chatConnecting: 'Connecting to chat…', bankNotFree: 'That Uril bank is no longer free.', onlineNotReady: 'Online mode is not connected yet.', playerAlreadyBusy: '{nick} is already in an Uril bank.', defaultBankName: '{nick}’s bank', invitationSent: 'Invitation sent to {nick}.',
    connectSupabaseBanks: 'Connect Supabase to open online Uril banks.', noBanks: 'There are no Uril banks yet. Create the first one.', waitingUpper: 'WAITING', playingUpper: 'IN PLAY', resume: 'Resume', play: 'Play', watchPlay: 'Watch', awaitingGuest: 'Waiting…', bankOnline: 'Online bank', versusPcMode: 'AGAINST PC · {level}', watchingMode: 'WATCHING', onlineBankMode: 'ONLINE BANK', twoPlayersMode: 'TWO PLAYERS',
    matchFinished: 'Match ended', turnOf: '{player} to move', bankWaitingOpponent: 'Bank waiting for an opponent', watchingBank: 'Watching · South at the bottom', yourSideBelow: 'Your side is at the bottom · {player}', computerLevel: 'Computer at {level} level', localBank: 'Local bank on the same device',
