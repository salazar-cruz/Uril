...
const TEXT = {
  ...
  fr: {
    ...
    helpVersion: 'AIDE 1.0.1', helpTitle: 'Aide, banques et règles', close: 'Fermer',
    helpContent: `
  ...
  en: {
    ...
    helpVersion: 'HELP 1.0.1', helpTitle: 'Help, banks and rules', close: 'Close',
    helpContent: `
      ...
      <p class="rules-note">Version 1.0.1 will continue to be refined with experienced Uril players.</p>`,
