import {
  ...
  resignGame,
  resignationValue,
} from './engine.js?v=0.0.17';
import { chooseMove, shouldOfferResignation } from './ai.js?v=0.0.17';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=0.0.17';
import { MultiplayerService } from './multiplayer.js?v=0.0.17';
import { boardRowsForPerspective, seatPlayers } from './perspective.js?v=0.0.17';
import { applyTranslations, getLanguage, localeForLanguage, setLanguage, t } from './i18n.js?v=0.0.17';
...
function classicSpriteUrl(seedTotal) {
  ...
  return new URL(`../assets/premium/trou-bonduc${spriteName}.png`, import.meta.url).href;
}
...
function chooseMoveAsync(game, level) {
  ...
  return new Promise((resolve, reject) => {
    const worker = new Worker(
      new URL('./ai-worker.js?v=0.0.17', import.meta.url),
      { type: 'module' },
    );
